        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (intentData.length() > 0) {
                    String[] urlar = intentData.split("=");
                    String custcode = "";
                    if(urlar.length>1) custcode = urlar[1];

                    Intent intent = new Intent();
                    intent.putExtra("keyop", _keyop);
                    intent.putExtra("item1", custcode);
                    intent.putExtra("item2", "");
                    intent.putExtra("item3", "");
                    intent.putExtra("item4", "");
                    intent.putExtra("item5", "");
                    intent.putExtra("item6", "");
                    intent.putExtra("item7", "");
